        ...
        <div  id='home' className='h-full w-full bg-[#0D0D0D]'>
            ...
            <section className='h-screen px-6 flex flex-col relative isolate pt-36 lg:flex lg:flex-row lg:justify-around lg:items-center lg:pt-0'>
                ...
                <div className='flex flex-col lg:justify-start items-center text-center h-[10rem] sm:h-60 lg:w-1/2 lg:h-auto'>
                    <h1 id='title' className='text-gray-100 font-bold text-4xl sm:text-6xl h-auto cursor-default' data-aos="fade-right">{t("title")}</h1>
            ...
            <section className='relative isolate'>
                <div className="absolute inset-x-0 bottom-28 md:bottom-44 -z-20 transform-gpu blur-[12rem] overflow-hidden sm:-top-54" aria-hidden="true">
                    <div className="relative right-[15rem] h-[20rem] aspect-[1155/678] w-[36.125rem] translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-purple-950 to-purple-950 md:right-[calc(100%-24rem)] lg:right-[calc(100%-35rem)] sm:w-[72.1875rem]"></div>
                </div>
            </section>
            <Footer/>
        </div>
